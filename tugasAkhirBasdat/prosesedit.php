...
if(isset($_POST['konfirmasi']))
{
	...
	// buat query
  	$query = pg_query("UPDATE pesanan SET kuantitas = '$kuantitas', alamat_tujuan = '$alamat_tujuan' WHERE id = '$id_pesanan' AND id_users = '$id_user' AND id_makanan = '$id_makanan'");
	...
	else 
	{
		...
		header('Location: pesanan.php?id='.$id_user.'&status=gagal');
	}
